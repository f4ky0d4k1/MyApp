...
import com.example.myapp3.Network.Profile;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        textSurnameHint = findViewById(R.id.text_surname_hint);
        textNameHint = findViewById(R.id.text_name_hint);
        textPatronymicHint = findViewById(R.id.text_patronymic_hint);
